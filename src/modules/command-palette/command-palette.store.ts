...
export const useCommandPaletteStore = defineStore('command-palette', () => {
  ...
  const searchOptions: PaletteOption[] = [
    ...
    },
    {
      ...
      href: 'https://github.com/zj870891544/useful-tools',
      category: 'External',
      description: 'View the source code of DevToolBox on Github.',
      keywords: ['github', 'repo', 'repository', 'source', 'code'],
      icon: GithubIcon,
    },
    {
      name: 'Report a bug or an issue',
      description: 'Report a bug or an issue to help improve DevToolBox.',
      href: 'https://github.com/zj870891544/useful-tools/issues/new/choose',
      category: 'Actions',
